...
$(function(){
	...
	scrollPic_02.frameWidth     = 1002;
	scrollPic_02.pageWidth      = 166; 
	...
	var bannerImg = ["/style/images/banner_home_left_01.png","/style/images/banner_home_left_02.png","/style/images/banner_home_left_03.png","/style/images/banner_home_left_04.png","/style/images/banner_home_left_05.png"];//定义左边的图片
	var bannerIcon = ["/style/images/banner_home_right_icon_01.png","/style/images/banner_home_right_icon_02.png","/style/images/banner_home_right_icon_03.png","/style/images/banner_home_right_icon_04.png","/style/images/banner_home_right_icon_05.png"];
	bH1C = ["全方位网络互动营销方案","营销从打动用户设计开始","专业摄影色诱网站访客","简约细致用户体验不思考","提升转化率真正实现营销"]; 
	bH3C = ["网站基础策划、产品亮点提升、高效网络推广、网站流量监测、细致访客沟通等全方位网络互动营销方案。将过程整合并融合成整体，促成网络营销的成功！",
		"网站想要用户喜欢，首先就得在视觉上打动用户；规划网站视觉要从用户的审美习惯出发，绝不凭主观愿望来确定视觉表现，您的网站是用来打动用户的！",
		"极具销售力的商品展示是网站规划的核心要素，商品展示的销售力其核心关键就在于提炼产品的核心卖点，然后利用图、文、视频等各种形式围绕和强化核心卖点！",
		"网站用户体验包括网站平台体验、商品体验、内容体验和服务体验等，每一个方面都是很重要不可缺少。正点网络用耐心、细心，提供细致入微的页面互动感受！",
		"访客既能够感受美又能够接近美，从技术到艺术，欣赏油然而生，身心的愉悦，从单纯了解产品到心智的共鸣！公司做的是产品更是可欣赏的伟大艺术品！"];
	bBH = ["#","#","#","#","#"];
	...
	$(".Features a").hover(function(){
		...
		$(this).find("dt").css({background:"url(http://www.czxixi.com/images/sprite.jpg) "+aN+"px -152px "});
	},function(){
	...
	var cooperate = "<span class='box'></span><span class='box'></span><span class='box'></span><span class='box'></span><span class='box'></span><span class='box'></span><span class='box'></span><span class='box'></span>";
	$("#ISL_Cont_1 div").eq(0).append(cooperate);
	for(var i = 0 ; i < 8 ; i++){
		$(".box").eq(i).css({background:"url(/style/images/sprite.jpg) -"+140*i+"px 0"});
	}
