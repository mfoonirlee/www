var scrolltotop={
	...
	controlHTML:'<a href="javascript:;" class="M-menu2 fl" style="width:60px; height:59px; border:0;display=:block;background:url(/dedemao/images/menu.png) no-repeat;margin-right:2px;" /></a><a href="http://www.dream-gardens.com.cn/#contact" target="_blank" class="M-menu3 fl"  style="width:60px; height:59px; border:0;display=:block;background:url(/dedemao/images/menu2.gif) no-repeat;" ></a>', //返回顶部按钮
